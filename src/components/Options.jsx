const Options = () => {
    return(
        <div className="Options">
            ...
            <p>Wanna contact with me? <a style={{ marginLeft: "15px", color: "var(--white)" }} className="Button1" href="https://wojciechglid.netlify.app/" target="_blank">MY PORTFOLIO PAGE</a></p>
        </div>
    )
}
