    ...
    return createPortal(
        <>
            ...
            <div className="ConfirmEmail" style={modalStyle}>
                ...
                <p style={{ color: "var(--gray)" }}>We have sent you email to confirm the validity of your email address. If you cannot see your mail, check spam folder or <span style={{ color: "var(--black)", cursor: "pointer" }}>resend email</span>.</p>
            </div>
        </>
        ,
